...
class _HomeScreen extends State<HomeScreen> {
  ...
  bool pressGeoON = false;  // for keeping trrack of button state
  bool cmbscritta = false;  // for keeping trac of button state

 //  /****************this part uses the map box reverse geocodoing**************************/  //
...
//Set up a test api key before running for maboxsearch package
 String apiKey = "Map box api key here"; 
// Map-box geocoding requires the initialisation below
 MapboxGeocoding geocoding = MapboxGeocoding("map box api key here");
//////////////////////////////////////////////////////////////////////////////////////////
...
// set the address to the value returned by map box api
  setState(() {
